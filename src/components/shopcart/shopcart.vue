<template>
  <div class="shopcart">
    <div class="content" @click="toggleList">
      ...
      <div class="content-right">
        <div class="pay" :class="payClass" v-on:click.stop.prevent="pay">
          {{payDesc}}
        </div>
      </div>
    </div>
  ...
  <div class="list-mask" v-show="listShow" transition="fade" v-on:click="toggleList">
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      pay() {
        ...
        window.alert(`应该支付${this.totalPrice}元!`);
      },
      empty() {
        this.selectFoods.forEach((food) => {
          food.count = 0;
  ...
  .shopcart
    ...
    .ball-container
      .ball
        ...
        z-index: 200
        &.drop-transition
          transition: all .4s cubic-bezier(0.49, -0.3, .75, .44)
          .inner
            width: 16px
            height: 16px
            border-radius: 50%
